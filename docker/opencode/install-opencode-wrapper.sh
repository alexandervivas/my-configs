...
collect_defaults() {
  ...
  selected_mounts="$(prompt_multi_choice "Select host mounts (comma-separated: aws, ssh, gitconfig, m2, opencode, none)" "${default_mounts}" aws ssh gitconfig m2 opencode none)"
